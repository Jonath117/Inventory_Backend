...
namespace Inventory.Infrastructure.Migrations
{
    ...
    [Migration("20260518015306_AddWarehouseAndMovementCens")]
    partial class AddWarehouseAndMovementCens
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "CategoryCen")
                        .IsUnique()
                        .HasDatabaseName("ix_categories_company_id_category_cen");
            ...
            modelBuilder.Entity("Inventory.Domain.Entities.Unit", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "UnitCen")
                        .IsUnique()
                        .HasDatabaseName("ix_units_company_id_unit_cen");
